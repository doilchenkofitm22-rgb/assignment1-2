...
* Аудитні події логіну та невдалих спроб входу;
* Використання стійких хешів для паролів;
* Налаштований процес тріажу та виправлення виявлених вразливостей.

Очікувані ризики на старті: SQL‑інʼєкція у пошуку, відображена XSS на сторінці echo, слабка автентифікація через зберігання паролів у відкритому вигляді, можливі вразливості в сторонніх залежностях та витік секретів через файли конфігурацій.

## 1. Область застосунку

Функціональність складається з домашньої сторінки, форми пошуку, відображення результатів, авторизації користувачів та сторінки профілю. Дані зберігаються в SQLite. Програмне забезпечення є навчальним прототипом для демонстрації інтеграції безпеки в SDLC.
...
- **Експлуатаційність:** наявність задокументованого процесу тріажу та виправлення вразливостей; інтеграція з системою відстеження задач.
...
- **Конфіденційність (C):** захист даних облікових записів, сесійних токенів та будь‑якої особистої інформації;
- **Цілісність (I):** гарантія, що результати пошуку та профілі не модифікуються сторонніми;
...
Подальші етапи SDLC включатимуть оцінку цих ризиків та поступове їх усунення.